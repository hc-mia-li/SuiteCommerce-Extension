...
<!--		<script>-->
<!--			if (SC && SC.ENVIRONMENT.currentHostString) {-->
<!--				$("[data-permissions='transactions.tranRtnAuth.2']").attr('href',new URL('https://'+SC.ENVIRONMENT.currentHostString+'/public-return-authorization'))-->
<!--			}-->
<!--		</script>-->
<!--		<a data-permissions="transactions.tranRtnAuth.2" href="" class="order-history-summary-button-request-return">-->
